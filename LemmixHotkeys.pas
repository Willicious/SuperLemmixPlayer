...
begin
  ...
  //SetKeyFunction($33, lka_Skill, Integer(spbTimebomber));   //bookmark timebomber
...
begin
  ...
  //SetKeyFunction($63, lka_Skill, Integer(spbTimebomber));   //bookmark timebomber
...
class function TLemmixHotkeyManager.InterpretSecondary(s: String): Integer;
  begin
    ...
    else if s = 'timebomber' then Result := Integer(spbTimebomber)   //bookmark timebomber
  ...
  begin
    case aMain of
      lka_Skill:  case aValue of
                    ...
                    Integer(spbTimebomber): Result := 'Timebomber';   //bookmark timebomber
