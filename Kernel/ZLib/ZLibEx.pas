...
type
  ...
  public
    property TotalBytesIn: integer read FZStream.total_in; { #EL }
    property TotalBytesOut: integer read FZStream.total_out; { #EL }
    property AvailBytesOut: integer read FZStream.avail_out; { #EL }
  end;
