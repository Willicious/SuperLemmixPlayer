...
begin
  ...
  // Walker, Jumper, Shimmier, Ballooner, Runner, Slider, Climber, Swimmer, Floater, Glider, Disarmer - all simple
  ...
  DrawAnimationFrame(SkillIcons[Integer(spbRunner)], RUNNING, 1, PICKUP_MID + 1, PICKUP_BASELINE - 2);
